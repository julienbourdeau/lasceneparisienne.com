    ...
    <div x-data="{apiResponse: false}">
        ...
        <div class="lg:flex lg:flex-row-reverse">
            ...
            <div class="lg:w-2/3">
                ...
                @include('_partials.admin-actions', ['model' => $event, 'apiResponse' => true])
        ...
        @auth
            <div x-show="apiResponse" class="my-16 p-4 bg-gray-100 border" style="display: none;">
                @php
                  $apiResponse = json_encode($event->toArray(), JSON_PRETTY_PRINT);
                @endphp
                {!! markdown("```json\n {$apiResponse} \n```") !!}
            </div>
        @endauth
