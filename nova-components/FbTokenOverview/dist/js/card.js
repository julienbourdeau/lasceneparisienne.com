...
Nova.booting(function (Vue, router, store) {
  Vue.component('fb-token-overview', __webpack_require__(2));
});
...
var render = function() {
  ...
  return _c("card", { staticClass: "flex flex-col center justify-center" }, [
    _c("div", { staticClass: "text-xl" }, [
      _c("div", { staticClass: "px-3 py-2" }, [
        _c("span", { staticClass: "text-80 font-light" }, [
          _vm._v("Fb Token:")
        ]),
        _vm._v(" "),
        _c("span", { staticClass: " font-mono" }, [
          _vm._v(_vm._s(_vm.card.token))
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "px-3 py-2" }, [
