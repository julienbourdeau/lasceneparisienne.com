...
Nova.booting(function (Vue, router, store) {
  Vue.component('facebook-import-status', __webpack_require__(2));
});
    ...
    [
      _c("div", { staticClass: "px-3 py-3" }, [
        _c("h1", { staticClass: "text-center text-3xl text-80 font-light" }, [
          _vm._v(_vm._s(_vm.card.lastImported))
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "text-right font-light pt-1" }, [
          _vm._v(
            "\n            Last run imported " +
              _vm._s(_vm.card.lastCount) +
              " events.\n        "
          )
        ])
      ])
